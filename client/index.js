var web3 = new Web3(Web3.givenProvider); //calling Metamask authentication
var instance;
var user;
var dnaStr = "457896541299";

//Note: This contract address is generated by truffle running on the ETH testnet
// it is generated for the purpose of doing this project, and are not meant to
// be use for production.  DO NOT INTERACT it with mainnet crypto and/or ERC721 tokens
var contract = "0x3A18BBB8046142c44E86C4a17A2a8EE12E3bDcf8";
var contractOwner;

//check using jquery
$(document).ready(function () {
  // a prompt that let the user to connect their Metamask to the site
  window.ethereum.enable().then(function (accounts) {
    // abi = application binary interface, contract abi can be obtain in the build folder
...
function createKitty() {
  ...
  let res;
  try {
    // send() are use to send function to smart contract,
    //  can add callback function to recieve results from the smart contract
    //  for more explanations see: https://web3js.readthedocs.io/en/v1.2.9/web3-eth-contract.html#contract-events
